...
function add_css(target) {
	append_styles(target, "svelte-bpl9lm", "h1.svelte-bpl9lm{color:red}.special.svelte-bpl9lm{color:blue}");
}
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h10, "class", "svelte-bpl9lm");
			attr(h11, "class", "special svelte-bpl9lm");
		},
		m(target, anchor) {
